...
class EblanVpnService : VpnService(), CoreCallbackHandler {
    ...
    override fun onCreate() {
        ...
        Log.d(TAG, "Service created, core env initialized")
    }
    ...
    private fun startVpnTunnel(server: ServerConfig) {
        ...
        serviceScope.launch {
            try {
                ...
                // Create CoreController and start the loop
    ...
    override fun startup(): Long {
        Log.d(TAG, "libv2ray core startup callback")
        return 0
    }

    override fun shutdown(): Long {
        Log.d(TAG, "libv2ray core shutdown callback")
        return 0
    }
